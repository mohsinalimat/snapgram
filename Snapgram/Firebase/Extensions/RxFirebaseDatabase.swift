...
public extension DatabaseQuery {
    ...
    /**
     ...
     @param eventType The type of event to listen for.
     */
    func rx_observeWithSiblingKey(_ eventType: DataEventType) -> Observable<(DataSnapshot, String?)> {
        return Observable.create { observer in
    ...
    /**
     ...
     @param eventType The type of event to listen for.
     */
    func rx_observeSingleEventOfType(of eventType: DataEventType) -> Observable<DataSnapshot> {
        return Observable.create { observer in
    ...
    /**
     ...
     @param eventType The type of event to listen for.
     */
    func rx_observeSingleEventWithSiblingKey(of eventType: DataEventType) -> Observable<(DataSnapshot, String?)> {
        return Observable.create { observer in
...
public extension DatabaseReference {
     ...
     */
    func rx_updateChildValues(_ values: [AnyHashable: Any]) -> Observable<DatabaseReference> {
        return Observable.create { observer in
     ...
     */
    func rx_setValue(_ value: Any?, andPriority priority: Any? = nil) -> Observable<DatabaseReference> {
        return Observable.create { observer in
     ...
     */
    func rx_runTransactionBlock(block: @escaping ((MutableData) -> TransactionResult)) -> Observable<(isCommitted: Bool, snapshot: DataSnapshot?)> {
        return Observable.create { observer in
     ...
     */
    func rx_setPriority(_ priority: Any?) -> Observable<DatabaseReference> {
        return Observable.create { observer in
     ...
     */
    func rx_onDisconnectSetValue(_ value: Any?, priority: Any? = nil) -> Observable<DatabaseReference> {
        return Observable.create { observer in
     ...
     */
    func rx_onDisconnectUpdateChildValue(_ values: [AnyHashable: Any]) -> Observable<DatabaseReference> {
        return Observable.create { observer in
